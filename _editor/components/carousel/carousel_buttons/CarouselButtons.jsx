...
export default class CarouselButtons extends Component {
   ...
   */
    getParent() {
        ...
        return (
            this.props.navItems[
                this.props.navItems[this.props.indexSelected].parent
            ] || this.props.navItems[0]
        );
    }
   ...
   */
    canDeleteContainedView(id) {
        ...
        parent &&
        boxes[parent] &&
        boxes[parent].containedViews &&
        boxes[parent].containedViews.indexOf(id) === -1;
    ...
    render() {
        return (
            ...
            this.props.navItems[this.props.indexSelected].level >= 10
                ...
                >
                    <i className="material-icons">slideshow</i> Tambah Halaman
                </Button>

                {/* <OverlayTrigger
          placement="top"
          overlay={
            <Tooltip id="duplicateNavTooltip">
              {i18n.t("DuplicateNavItem")}
            </Tooltip>
          }
        >
          <Button
          ...
          >
            <i className="material-icons">control_point_duplicate </i>
                ...
                <OverlayTrigger
                    placement="top"
                    overlay={<Tooltip id="deleteTooltip">{i18n.t("delete")}</Tooltip>}
                >
                    <Button
                        className="carouselButton"
                        name="delete"
                        ...
                        style={{ color: "red" }}
                    >
                        <i className="material-icons">delete</i> Hapus
                    </Button>
                </OverlayTrigger>
                    ...
                    <Popover
                        ...
                        title={
                            isSection(this.props.indexSelected)
                                ...
                                : isContainedView(this.props.indexSelected)
                                    ? i18n.t("delete_contained_canvas")
                                    : i18n.t("delete_page")
                        }
                    >
                        <i
                            style={{ color: "yellow", fontSize: "13px", padding: "0 5px" }}
              ...
              warning
                        ...
                        {isSection(this.props.indexSelected)
                            ...
                            : isContainedView(this.props.indexSelected) &&
                !this.canDeleteContainedView(this.props.indexSelected)
                                ? i18n.t("messages.delete_busy_cv")
                        ...
                        <Button
                            ...
                            disabled={
                                /* (isContainedView(this.props.indexSelected) && !this.canDeleteContainedView(this.props.indexSelected)) || */ this
